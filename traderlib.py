...
class Trader:
    ...
    def load_historical_data(self,ticker,interval,period):
        ...
        try:
            ...
            data = ticker.history(period,interval) # WARNING: check parameter order
    ...
    def get_shares_amount(self,assetPrice):
        ...
        try:
            ...
            if equity - sharesQuantity*assetPrice > 0:
                ...
                lg.info('Cannot spend %.2f, remaining equity is %.2f, aborting...' % (sharesQuantity * assetPrice, equity))
                sys.exit()
    ...
    def get_general_trend(self,ticker):
        ...
        try:
            while True:
                ...
                if (ema50 < ema26) and (ema26 < ema9): # WARNING: double check the comparator
                    lg.info('Trend detected for %s: long' % ticker)
                    return 'long'
                elif (ema50 > ema26) and (ema50 > ema9): # WARNING: double check the comparator
    ...
    def get_instant_trend(self,ticker,trend):
        ...
        try:
            while True:
                ...
                if (trend == 'long') and (ema9 > ema26) and (ema26 > ema50): # WARNING: double check comparators
    ...
    def run(self,ticker):
        ...
        while True:
            ...
            sharesQty = self.get_shares_amount(self.currentPrice) # WARNING： potentially missing parameter 'ticker'
